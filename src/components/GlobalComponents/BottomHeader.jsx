      ...
      <div className="container px-2 2xl:px-0">
        <div className="grid grid-cols-12 items-center">
          <div className='col-span-3 xl:col-span-4 hidden lg:block'>
            <div className="grid grid-cols-12 items-center">
              <div className='xl:col-span-8 2xl:col-span-7 col-span-12'>
              ...
              <div className='xl:flex items-center justify-start xl:col-span-4 2xl:col-span-5 hidden'>
          ...
          <div className='col-span-2 xl:col-span-2 2xl:col-span-3 items-center justify-end hidden lg:flex'>
